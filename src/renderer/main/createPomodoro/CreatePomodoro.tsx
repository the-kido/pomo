...
import { DEFAULT_POMO_TIMER, PomoActivityType, PomoActivityTypeDisplay, PomodoroTimerInfo } from "/src/types/Pomodoro"
...
export function updateStageCleared(isCompleted: boolean, stage: Stages, stagesClearedContext: StagesCompletedType, stageAt: Stages) {
...
function CreatePomodoro({info, onSaved, reset} : {info? : PomodoroTimerInfo, onSaved?: (newPomo: PomodoroTimerInfo) => void, reset?: () => void}) {
	...
	const [newPomo, _] = useState<PomodoroTimerInfo>(info ? {...info} : DEFAULT_POMO_TIMER);
